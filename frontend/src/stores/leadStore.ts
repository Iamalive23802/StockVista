...
export interface Lead {
  ...
  status: 'New' | 'Busy' | 'Call Back With Presentation' | 'Call Back Without Presentation' | 'Call Disconnected' | 'Counselling Call' | 'Disconnected Call' | 'Do Not disturb' | 'Equity trader' | 'Follow Up' | 'Follow Up-No Response' | 'Free Trial' | 'Free Trial – Follow Up' | 'Incoming Calls Not Allowed' | 'Invalid Number' | 'Language Barrier' | 'Less Funds' | 'Loss Client' | 'Low Capital' | 'No Capital' | 'No DMAT' | 'No Response' | 'Non Trader' | 'Not Connected' | 'Not Interested' | 'Not Reachable' | 'Out Of Service' | 'Paid Client' | 'Promise To Pay' | 'Ringing' | 'Summarization Call' | 'Switched Off' | 'Wrong No';
  team_id: string;
  assigned_to?: string;
